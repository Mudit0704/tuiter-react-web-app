   ...
   <div class="list-group">
     <a class="list-group-item" href="#">
       <i class="fab fa-twitter"></i></a>
          ...
          <i class="fas fa-home pe-2"></i><a href="#" class="wd-navs d-none d-xl-inline-block text-white">Home</a>
        </li>
        <li class="list-group-item active">
          <i class="fas fa-hashtag pe-2"></i><a href="#" class="wd-navs d-none d-xl-inline-block text-white">Explore</a>
        </li>
        <li class="list-group-item">
